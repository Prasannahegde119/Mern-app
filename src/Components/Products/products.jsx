        ...
        <div className="row">
          ...
          <div className="col-md-6">
            ...
            <div className="d-flex align-items-center">
              <button className="btn btn-sm btn-secondary me-2" onClick={decreaseQuantity}>-</button>
              <span>{quantity}</span>
              <button className="btn btn-sm btn-secondary ms-2" onClick={increaseQuantity}>+</button>
            </div>
