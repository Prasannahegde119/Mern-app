  ...
  return (
    <div className="add-products-container">
      ...
      <form onSubmit={handleSubmit} className="add-products-form">
        ...
        <input type="number" id="rating" name="rating" value={product.rating} onChange={handleChange} required />

        <label htmlFor="ratingCount">Rating Count:</label>
        <input type="number" id="ratingCount" name="ratingCount" value={product.ratingCount} onChange={handleChange} required />
